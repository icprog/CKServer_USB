    ...
    public partial class LoadFPGAForm : Form
    {
        ...
        private void buttonEdit1_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            else
            {
                ...
                if (USB.MyDeviceList[Data.Cardid1] != null)
                {
                    USB.MyDeviceList[Data.Cardid1].Reset();
                    USB.SendCMD(Data.Cardid1, 0x80, 0x01);
                    Thread.Sleep(20);
                    USB.SendCMD(Data.Cardid1, 0x80, 0x00);
                    ...
                    for (int i = 0; i < Send_Times; i++)
                    {
                        ...
                        USB.SendData(Data.Cardid1, SendBytes);
