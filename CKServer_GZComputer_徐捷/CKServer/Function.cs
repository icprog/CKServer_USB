...
namespace CKServer
{
    class Function
    {
        public static void Init()
        {
            ...
            for (int i = 0; i < 128; i++)
            {
                Data.DA1_value_a[i] = double.Parse(Data.GetConfig(Data.DAconfigPath, "DAModify_Board1_A" + (i).ToString()));
                Data.DA1_value_b[i] = double.Parse(Data.GetConfig(Data.DAconfigPath, "DAModify_Board1_B" + (i).ToString()));

                Data.DA2_value_a[i] = double.Parse(Data.GetConfig(Data.DAconfigPath, "DAModify_Board2_A" + (i).ToString()));
                Data.DA2_value_b[i] = double.Parse(Data.GetConfig(Data.DAconfigPath, "DAModify_Board2_B" + (i).ToString()));

                //Data.DA1_value_a[i] = 130;
                //Data.DA1_value_b[i] = 7800;
                //Data.DA2_value_a[i] = 130;
                //Data.DA2_value_b[i] = 7800;
